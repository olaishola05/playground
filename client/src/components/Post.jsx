            ...
            <div className={classes.postWrapper}>
                <div className={classes.postContainer}>
                    ...
                    <div className={classes.postTop}>
                        <img src="./assets/img/gee.jpeg" alt="" className={classes.userImg} />
                    ...
                    <div className={classes.postCenter}>
                        <span className={classes.postText}>{desc ? desc : desc}</span>
                        <img src={photo} alt="" className={classes.postImg}/>
                    </div>

                    <div className={classes.postBottom}>
                        <div className={classes.postLike}>
                            <img src="./assets/img/heart.png" alt="" className={classes.postLikeIcons}/>
                            <img src="./assets/img/like.png" alt="" className={classes.postLikeIcons}/>
                            <span className={classes.postLikes}>{like} people liked this posts</span>
                        </div>
